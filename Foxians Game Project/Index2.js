    ...
    const ladderMap = {
        3: ["After arriving at the office, I created and submitted the DPT.\n DPT stands for Daily Plan Task, where we outline the tasks we need to accomplish after arriving at the office.", 22],
        7: ["Upon receiving the task, I created and submitted the WBS.\n WBS stands for Work Breakdown Structure, which involves breaking down assigned tasks into smaller components to create a structured plan. We then use this plan to create the DPT.", 31],
        51: ["I completed 6 tasks and created a unique project for the company.", 95],
        24: ["Whenever there were any problems related to tasks, I asked questions on Allemp.\n Allemp is a Gmail group where we raise and resolve questions.", 44],
        ...
        60: ["I presented during Rising career session and participated in group discussions.\n Rising career session. ye ek session hai jisme hum apne soft skill ko enhance karte hai jiase communication presentation group disscution etc.", 87],
        67: ["I asked questions during the session.", 81]
    };

    const snakeMap = {
        16: ["After coming to the office, I forgot to send the DPT \n DPT stands for Daily Plan Task, where we outline the tasks we need to accomplish after arriving at the office.", 4],
        ...
        85: ["I did not raise any questions on Allemp regarding any problems related to tasks. \n Allemp is a Gmail group where we raise and resolve questions.", 47],
    ...
    function rollDice() {
        ...
        document.getElementById('diceResult').innerText = `Dice Result: ${diceResult}`;
    ...
    function endGame() {
        ...
        if (!endTime) {
            ...
            document.getElementById('gameTime').innerText = `Game Time: ${seconds} seconds`;
        }
    }
    ...
    function quit() {
        ...
        window.location.href = "file:///home/himanshu/Documents/Foxians%20Game%20Project/login-form/index.html";
    }
    function restart() {
